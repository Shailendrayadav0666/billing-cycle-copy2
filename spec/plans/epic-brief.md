...
> **Server / tool**: helix . get_solution_document_tool (document_id=3157)
> **Estate**: Billing-Cycle-AIRE-V1-Demo (solution_id 874) / repo Billing-Cycle @ main
> **Scope pulled**: Epic solution document (owner-authored, lifecycle_state=CURRENT, version 1)
> **Fetched**: 2026-09-03T07:56:53Z
> **Freshness**: last_ingested_commit bcec649e08f2dbec435c24066deae6a1d6d71192
...
The following files were read and analyzed to produce this epic:
...
- `Billing-Cycle/frontend/src/pages/Billing.jsx` — Hardcoded "Standard" badge (line 128), plan card layout, fetch pattern, state shape — all directly inform what changes are needed
